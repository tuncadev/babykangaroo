...
class Iconic_WLV_Core_Settings {
			...
			$settings['sections']['licence'] = array(
				...
				'fields'              => array(
					array(
						...
						'type'     => 'custom',
						'output'   => Iconic_WLV_Core_Licence::admin_account_link(),
					),
					array(
						'id'       => 'account',
	...
	public static function add_sidebar() {
		...
		$cross_sells  = Iconic_WLV_Core_Cross_Sells::get_selected_plugins();
					...
					<?php foreach ( $cross_sells as $cross_sell ) { ?>
						<div class="iconic-product">
							...
							<div class="iconic-product__content">
								<h4 class="iconic-product__title"><a target="_blank" href="<?php echo esc_url( $cross_sell['link'] ); ?>?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-wlv&utm_content=cross-sell" target="_blank"><?php echo wp_kses_post( $cross_sell['title']['rendered'] ); ?></a></h4>
