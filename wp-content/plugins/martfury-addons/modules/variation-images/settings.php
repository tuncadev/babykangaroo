...
class Settings  {
	...
	public function variation_images_section( $sections ) {
		$sections['martfury_variation_images'] = esc_html__( 'Variation Images Gallery', 'martfury' );
	...
	public function variation_images_settings( $settings, $section ) {
		if ( 'martfury_variation_images' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Variation Images Gallery', 'martfury' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				...
				'title'   => esc_html__( 'Variation Images Gallery', 'martfury' ),
				'desc'    => esc_html__( 'Enable Variation Images Gallery', 'martfury' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);
